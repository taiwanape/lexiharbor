...
const s = StyleSheet.create({
  ...
  desktopBar: { paddingHorizontal: 32, paddingVertical: 14, minHeight: 78 }, brand: { flexDirection: 'row', alignItems: 'center', gap: 10 },
